...
class WriterCSV {
  ...
  private val path: String =
    getClass.getResource("").getPath.replaceAll("/", "/")
  private val decodedPath: String = URLDecoder.decode(path, "UTF-8")
  private val grandparentDirectory: String =
    decodedPath.split("/").dropRight(4).mkString("/")
  private val resourcesDirectory: String =
    grandparentDirectory + "/src/main/resources"
